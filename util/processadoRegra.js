...
exports.processado_Inclusao = async function (processado) {
  try {
    const obj = await processadoSrv.getProcessado(
    ...
    if (obj != null) {
      throw new erroDB.UserException("Regra de negócio", [
        {
          tabela: "PROCESSADO",
          message: `"INCLUSÃO" Registro Já Existe Na Base De Dados.! ${processado.id_empresa},${processado.id_tarefa},${processado.codigo}`,
        },
      ]);
    }
  } catch (err) {
