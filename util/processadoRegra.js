...
exports.processado_Inclusao = async function(processado) { 
	try { 
		const obj = await processadoSrv.getProcessado(processado.id_empresa,processado.id_tarefa,processado.codigo);
		if (obj != null) { 
...
exports.processado_Exclusao = async function(id_empresa,id_tarefa,codigo) { 
	try { 
		const obj = await processadoSrv.getProcessado(id_empresa,id_tarefa,codigo);
		if (obj == null) { 
